...
public class LITPdhcpserviceapiTestRunner extends TorTestCaseHelper {
    
    Logger logger = Logger.getLogger(LITPdhcpserviceapiTestRunner.class);
    ...
    @TestId(id = "CXP9031643-1", title = "Upgrade ERIClitpdhcpserviceapi rpm on the MS")
    @Test(groups={"ACCEPTANCE"})
    public void upgradeERIClitpdhcpserviceapiRPM() throws TimeoutException, FileNotFoundException {

        rpmUpgradeOperator.initialise("dhcpserviceapi");
     ...
     * @PRIORITY HIGH
     */
    @TestId(id = "CXP9031643-2", title = "Run python test cases for ERIClitpdhcpserviceapi package")
    @Test(groups={"CDB_REGRESSION", "ACCEPTANCE"})
    public void runERIClitpdhcpserviceapiTests() {
     ...
     * @PRE Execution of test {@link #runERIClitpdhcpserviceapiTests()}
     * @PRIORITY HIGH
     * @param className
     * @param name
     * @param failures
     */
    @TestId(id = "CXP9031643-3", title = "Parse xml outputs from python tests")
